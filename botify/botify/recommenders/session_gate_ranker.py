...
class SessionGateRanker(Recommender):
    ...
    try:
        ...
        # Важно: берем ТОЛЬКО baseline, БЕЗ popular_tracks
        candidates = valid_baseline[:20]
        
        # Строим признаки и предсказываем вероятности
        scores = {}
        ...
        # Рейтингование: на основе RandomForest вероятности (А НЕ gating!)
        # Берем кандидата с НАИВЫШЕЙ вероятностью из кандидатов SasRec
